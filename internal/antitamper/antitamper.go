...
func RunAllChecks() error {
	...
	if ExpectedBinaryHash != "" && !strings.HasPrefix(ExpectedBinaryHash, "SET_") && !strings.HasPrefix(ExpectedBinaryHash, "d1f5faeca30cde86b039df3487ca62406269cc45e33e9c01a65eaba7010b51c4") {
